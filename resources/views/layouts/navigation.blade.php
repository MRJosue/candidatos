        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden lg:flex lg:items-center lg:ms-6">
                <details class="relative">
                    <summary class="flex cursor-pointer list-none items-center px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none">
                    ...
                    <div class="absolute end-0 z-50 mt-2 w-48 rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5">
